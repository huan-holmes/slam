...
if(len(sys.argv) < 2):
    print("use,,python clf_to_ros_bag.py file_name*.clf")
    exit(0)
file_name = sys.argv[1]
bag_name = file_name[:-4] + ".bag"
print("convering {0} to ros bag {1}",file_name,bag_name)
...
print("convering {0} to ros bag {1} done !")
