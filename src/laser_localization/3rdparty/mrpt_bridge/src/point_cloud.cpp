 ...
 */
bool point_cloud::ros2mrpt(const sensor_msgs::PointCloud& msg, CSimplePointsMap& obj) {
 ...
 * \return true on sucessful conversion, false on any error.
 */
bool point_cloud::mrpt2ros(const CSimplePointsMap& obj, const std_msgs::Header& msg_header,
