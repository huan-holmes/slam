 ...
 * \sa mrpt2ros
 */
bool convert(const mrpt_msgs::ObservationRangeBeacon& _msg, const mrpt::poses::CPose3D& _pose,
...
bool convert(
    ...
    const mrpt::obs::CObservationBeaconRanges& _obj, mrpt_msgs::ObservationRangeBeacon& _msg);
