 ...
 */
inline void mrptToROSLoggerCallback(const std::string& msg, const VerbosityLevel level, const std::string& loggerName,
...
inline void mrptToROSLoggerCallback_mrpt_15(const std::string& msg, const VerbosityLevel level,
