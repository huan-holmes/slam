...
geometry_msgs::PoseWithCovariance& convert(const mrpt::poses::CPose3DPDFGaussian& _src,
                                           geometry_msgs::PoseWithCovariance& _des);

/** Convert: [MRPT] CPose3DPDFGaussianInf \rightarrow [ROS] PoseWithCovariance
 */
geometry_msgs::PoseWithCovariance& convert(const mrpt::poses::CPose3DPDFGaussianInf& _src,
                                           geometry_msgs::PoseWithCovariance& _des);
 ...
 * PoseWithCovariance */
geometry_msgs::PoseWithCovariance& convert(const mrpt::poses::CPosePDFGaussian& _src,
                                           geometry_msgs::PoseWithCovariance& _des);

/** Convert: [MRPT] CPosePDFGaussianInf (x,y,yaw) \rightarrow [ROS]
 * PoseWithCovariance */
geometry_msgs::PoseWithCovariance& convert(const mrpt::poses::CPosePDFGaussianInf& _src,
                                           geometry_msgs::PoseWithCovariance& _des);
...
mrpt::poses::CPose3DPDFGaussian& convert(const geometry_msgs::PoseWithCovariance& _src,
                                         mrpt::poses::CPose3DPDFGaussian& _des);

/** Convert: [ROS] PoseWithCovariance \rightarrow [MRPT] CPose3DPDFGaussianInf
 */
mrpt::poses::CPose3DPDFGaussianInf& convert(const geometry_msgs::PoseWithCovariance& _src,
                                            mrpt::poses::CPose3DPDFGaussianInf& _des);

/** Convert: [ROS] PoseWithCovariance \rightarrow [MRPT] CPosePDFGaussian
 * (x,y,yaw) */
mrpt::poses::CPosePDFGaussian& convert(const geometry_msgs::PoseWithCovariance& _src,
                                       mrpt::poses::CPosePDFGaussian& _des);

/** Convert: [ROS] PoseWithCovariance \rightarrow [MRPT] CPosePDFGaussianInf
 * (x,y,yaw) */
mrpt::poses::CPosePDFGaussianInf& convert(const geometry_msgs::PoseWithCovariance& _src,
