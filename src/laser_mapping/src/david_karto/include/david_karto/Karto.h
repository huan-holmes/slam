...
#ifndef DAVID_KARTO_KARTO_H
#define DAVID_KARTO_KARTO_H
...
#include <david_karto/Math.h>
#include <david_karto/Macros.h>
...
class KARTO_EXPORT Exception {
 public:
   ...
   * Copy constructor
   */
  Exception(const Exception& rException) : m_Message(rException.m_Message), m_ErrorCode(rException.m_ErrorCode) {}
 ...
 public:
   ...
   * @return error code
   */
  kt_int32s GetErrorCode() { return m_ErrorCode; }
...
class KARTO_EXPORT ParameterManager : public NonCopyable {
 public:
   ...
   * Destructor
   */
  virtual ~ParameterManager() { Clear(); }
 ...
 public:
  ...
  AbstractParameter* Get(const std::string& rName) {
    ...
    LOG(INFO) << "Unknown parameter: " << rName;
   ...
   */
  inline const ParameterVector& GetParameterVector() const { return m_Parameters; }
 ...
 public:
   ...
   * @return parameter of given name
   */
  AbstractParameter* operator()(const std::string& rName) { return Get(rName); }
...
class Name {
 ...
 public:
   ...
   * Equality operator.
   */
  kt_bool operator==(const Name& rOther) const { return (m_Name == rOther.m_Name) && (m_Scope == rOther.m_Scope); }

  /**
   * Inequality operator.
   */
  kt_bool operator!=(const Name& rOther) const { return !(*this == rOther); }

  /**
   * Less than operator.
   */
  kt_bool operator<(const Name& rOther) const { return ToString() < rOther.ToString(); }
 ...
 private:
   ...
   */
  inline kt_bool IsValidFirst(char c) { return (isalpha(c) || c == '/'); }
   ...
   */
  inline kt_bool IsValid(char c) { return (isalnum(c) || c == '/' || c == '_' || c == '-'); }
...
class KARTO_EXPORT Object : public NonCopyable {
 ...
 public:
   ...
   */
  virtual inline ParameterManager* GetParameterManager() { return m_pParameterManager; }
   ...
   * @return parameter
   */
  inline AbstractParameter* GetParameter(const std::string& rName) const { return m_pParameterManager->Get(rName); }
   ...
   * @return parameters
   */
  inline const ParameterVector& GetParameters() const { return m_pParameterManager->GetParameterVector(); }
 ...
 */
inline kt_bool IsSensor(Object* pObject) { return (pObject->GetObjectType() & ObjectType_Sensor) == ObjectType_Sensor; }
...
class KARTO_EXPORT Module : public Object {
 ...
 public:
   ...
   * Process an Object
   */
  virtual kt_bool Process(karto::Object*) { return false; }
...
class Vector2 {
 ...
 public:
   ...
   */
  inline kt_double SquaredLength() const { return math::Square(m_Values[0]) + math::Square(m_Values[1]); }

  /**
   * Returns the length of the vector (x and y).
   * @return length of the vector
   */
  inline kt_double Length() const { return sqrt(SquaredLength()); }

  /**
   * Returns the square distance to the given vector
   * @returns square distance to the given vector
   */
  inline kt_double SquaredDistance(const Vector2& rOther) const { return (*this - rOther).SquaredLength(); }
   ...
   */
  inline kt_double Distance(const Vector2& rOther) const { return sqrt(SquaredDistance(rOther)); }
 ...
 public:
   ...
   */
  inline const Vector2 operator/(T scalar) const { return Vector2(m_Values[0] / scalar, m_Values[1] / scalar); }
...
class Vector3 {
 ...
 public:
  ...
  inline const Vector3 operator+(const Vector3& rOther) const {
    return Vector3(m_Values[0] + rOther.m_Values[0], m_Values[1] + rOther.m_Values[1],
                   m_Values[2] + rOther.m_Values[2]);
  }
...
class Quaternion {
 ...
 public:
   ...
   */
  inline kt_double GetX() const { return m_Values[0]; }

  /**
   * Sets the X-value
   * @param x X-value of the quaternion
   */
  inline void SetX(kt_double x) { m_Values[0] = x; }

  /**
   * Returns the Y-value
   * @return Return the Y-value of the quaternion
   */
  inline kt_double GetY() const { return m_Values[1]; }

  /**
   * Sets the Y-value
   * @param y Y-value of the quaternion
   */
  inline void SetY(kt_double y) { m_Values[1] = y; }

  /**
   * Returns the Z-value
   * @return Return the Z-value of the quaternion
   */
  inline kt_double GetZ() const { return m_Values[2]; }

  /**
   * Sets the Z-value
   * @param z Z-value of the quaternion
   */
  inline void SetZ(kt_double z) { m_Values[2] = z; }

  /**
   * Returns the W-value
   * @return Return the W-value of the quaternion
   */
  inline kt_double GetW() const { return m_Values[3]; }

  /**
   * Sets the W-value
   * @param w W-value of the quaternion
   */
  inline void SetW(kt_double w) { m_Values[3] = w; }
  ...
  inline kt_bool operator==(const Quaternion& rOther) const {
    return (m_Values[0] == rOther.m_Values[0] && m_Values[1] == rOther.m_Values[1] &&
            m_Values[2] == rOther.m_Values[2] && m_Values[3] == rOther.m_Values[3]);
  }
  ...
  friend inline std::ostream& operator<<(std::ostream& rStream, const Quaternion& rQuaternion) {
    rStream << rQuaternion.m_Values[0] << " " << rQuaternion.m_Values[1] << " " << rQuaternion.m_Values[2] << " "
...
class Rectangle2 {
 ...
 public:
   ...
   * @param rY y
   */
  inline void SetPosition(const T& rX, const T& rY) { m_Position = Vector2<T>(rX, rY); }

  /**
   * Sets the position of this rectangle
   * @param rPosition position
   */
  inline void SetPosition(const Vector2<T>& rPosition) { m_Position = rPosition; }
...
class Pose2 {
 ...
 public:
   ...
   */
  inline kt_double GetX() const { return m_Position.GetX(); }

  /**
   * Sets the x-coordinate
   * @param x the x-coordinate of the pose
   */
  inline void SetX(kt_double x) { m_Position.SetX(x); }

  /**
   * Returns the y-coordinate
   * @return the y-coordinate of the pose
   */
  inline kt_double GetY() const { return m_Position.GetY(); }

  /**
   * Sets the y-coordinate
   * @param y the y-coordinate of the pose
   */
  inline void SetY(kt_double y) { m_Position.SetY(y); }

  /**
   * Returns the position
   * @return the position of the pose
   */
  inline const Vector2<kt_double>& GetPosition() const { return m_Position; }

  /**
   * Sets the position
   * @param rPosition of the pose
   */
  inline void SetPosition(const Vector2<kt_double>& rPosition) { m_Position = rPosition; }

  /**
   * Returns the heading of the pose (in radians)
   * @return the heading of the pose
   */
  inline kt_double GetHeading() const { return m_Heading; }

  /**
   * Sets the heading
   * @param heading of the pose
   */
  inline void SetHeading(kt_double heading) { m_Heading = heading; }

  /**
   * Return the squared distance between two Pose2
   * @return squared distance
   */
  inline kt_double SquaredDistance(const Pose2& rOther) const { return m_Position.SquaredDistance(rOther.m_Position); }
...
class Pose3 {
 public:
   ...
   */
  Pose3(const Vector3<kt_double>& rPosition) : m_Position(rPosition) {}
   ...
   * Copy constructor
   */
  Pose3(const Pose3& rOther) : m_Position(rOther.m_Position), m_Orientation(rOther.m_Orientation) {}
 ...
 public:
   ...
   */
  inline const Vector3<kt_double>& GetPosition() const { return m_Position; }

  /**
   * Set the position of the pose as a 3D vector. Values have units of meters.
   * @return 3-dimensional position vector
   */
  inline void SetPosition(const Vector3<kt_double>& rPosition) { m_Position = rPosition; }
   ...
   */
  inline void SetOrientation(const Quaternion& rOrientation) { m_Orientation = rOrientation; }
...
class Matrix3 {
 public:
   ...
   * Copy constructor
   */
  inline Matrix3(const Matrix3& rOther) { memcpy(m_Matrix, rOther.m_Matrix, 9 * sizeof(kt_double)); }
 ...
 public:
   ...
   */
  void Clear() { memset(m_Matrix, 0, 9 * sizeof(kt_double)); }
 ...
 public:
   ...
   */
  inline kt_double& operator()(kt_int32u row, kt_int32u column) { return m_Matrix[row][column]; }
   ...
   * @return mat(r,c)
   */
  inline kt_double operator()(kt_int32u row, kt_int32u column) const { return m_Matrix[row][column]; }
...
class Matrix {
 public:
   ...
   */
  Matrix(kt_int32u rows, kt_int32u columns) : m_Rows(rows), m_Columns(columns), m_pData(NULL) {
    Allocate();
 ...
 public:
   ...
   */
  inline kt_int32u GetRows() const { return m_Rows; }

  /**
   * Gets the number of columns of the matrix
   * @return nubmer of columns
   */
  inline kt_int32u GetColumns() const { return m_Columns; }
...
class BoundingBox2 {
 ...
 public:
   ...
   */
  inline const Vector2<kt_double>& GetMinimum() const { return m_Minimum; }

  /**
   * Set bounding box minimum
   */
  inline void SetMinimum(const Vector2<kt_double>& mMinimum) { m_Minimum = mMinimum; }

  /**
   * Get bounding box maximum
   */
  inline const Vector2<kt_double>& GetMaximum() const { return m_Maximum; }

  /**
   * Set bounding box maximum
   */
  inline void SetMaximum(const Vector2<kt_double>& rMaximum) { m_Maximum = rMaximum; }
...
class Transform {
 public:
   ...
   */
  Transform(const Pose2& rPose1, const Pose2& rPose2) { SetTransform(rPose1, rPose2); }
...
class AbstractParameter {
 public:
   ...
   */
  AbstractParameter(const std::string& rName, ParameterManager* pParameterManger = NULL) : m_Name(rName) {
   ...
   * @param pParameterManger
   */
  AbstractParameter(const std::string& rName, const std::string& rDescription,
...
class Parameter : public AbstractParameter {
 public:
   ...
   * @param pParameterManger
   */
  Parameter(const std::string& rName, const std::string& rDescription, T value,
            ParameterManager* pParameterManger = NULL)
 ...
 public:
   ...
   * @param rValue
   */
  inline void SetValue(const T& rValue) { m_Value = rValue; }
   ...
   */
  virtual Parameter* Clone() { return new Parameter(GetName(), GetDescription(), GetValue()); }
 ...
 public:
  ...
  virtual void SetValueFromString(const std::string& rStringValue) {
    if (m_EnumDefines.find(rStringValue) != m_EnumDefines.end()) {
      ...
      const_forEach(EnumMap, &m_EnumDefines) { validValues += iter->first + ", "; }
...
class KARTO_EXPORT Sensor : public Object {
 ...
 public:
   ...
   * @return offset pose
   */
  inline const Pose2& GetOffsetPose() const { return m_pOffsetPose->GetValue(); }

  /**
   * Sets this range finder sensor's offset
   * @param rPose
   */
  inline void SetOffsetPose(const Pose2& rPose) { m_pOffsetPose->SetValue(rPose); }
...
class KARTO_EXPORT SensorManager {
 ...
 public:
  ...
  void RegisterSensor(Sensor* pSensor, kt_bool override = false) {
    ...
    LOG(INFO) << "Registering sensor: [" << pSensor->GetName().ToString() << "]";
  ...
  void UnregisterSensor(Sensor* pSensor) {
    ...
    if (m_Sensors.find(pSensor->GetName()) != m_Sensors.end()) {
      LOG(INFO) << "Unregistering sensor: " << pSensor->GetName().ToString();
  ...
  SensorVector GetAllSensors() {
    ...
    forEach(SensorManagerMap, &m_Sensors) { sensors.push_back(iter->second); }
...
class Drive : public Sensor {
 ...
 public:
  virtual kt_bool Validate() { return true; }
 ...
 * to the robot. The user can set an offset pose for the sensor relative to the robot coordinate system. If no value is
 * provided by the user, the sensor is set to be at the origin of the robot coordinate system. The LaserRangeFinder
 * contains parameters for physical laser sensor used by the mapper for scan matching Also contains information about
 * the maximum range of the sensor and provides a threshold for limiting the range of readings. The optimal value for
 * the range threshold depends on the angular resolution of the scan and the desired map resolution.  RangeThreshold
 * should be set as large as possible while still providing "solid" coverage between consecutive range readings.  The
 * diagram below illustrates the relationship between map resolution and the range threshold.
 */
class KARTO_EXPORT LaserRangeFinder : public Sensor {
 ...
 public:
   ...
   */
  inline kt_double GetMinimumRange() const { return m_pMinimumRange->GetValue(); }
   ...
   */
  inline kt_double GetMaximumRange() const { return m_pMaximumRange->GetValue(); }
   ...
   */
  inline kt_double GetRangeThreshold() const { return m_pRangeThreshold->GetValue(); }
  ...
  inline void SetRangeThreshold(kt_double rangeThreshold) {
    ...
    if (math::DoubleEqual(GetRangeThreshold(), rangeThreshold) == false) {
      LOG(INFO) << "Info: clipped range threshold to be within minimum and maximum range!";
    }
  }
   ...
   */
  inline kt_double GetMinimumAngle() const { return m_pMinimumAngle->GetValue(); }
   ...
   */
  inline kt_double GetMaximumAngle() const { return m_pMaximumAngle->GetValue(); }
   ...
   */
  inline kt_double GetAngularResolution() const { return m_pAngularResolution->GetValue(); }
   ...
   * Return Laser type
   */
  inline kt_int32s GetType() { return m_pType->GetValue(); }
   ...
   */
  inline kt_int32u GetNumberOfRangeReadings() const { return m_NumberOfRangeReadings; }

  virtual kt_bool Validate() {
    Update();

    if (math::InRange(GetRangeThreshold(), GetMinimumRange(), GetMaximumRange()) == false) {
      LOG(INFO) << "Please set range threshold to a value between [" << GetMinimumRange() << ";" << GetMaximumRange()
                << "]";
      return false;
    }
  ...
  const PointVectorDouble GetPointReadings(LocalizedRangeScan* pLocalizedRangeScan,
                                           ...
                                           kt_bool ignoreThresholdPoints = true, kt_bool flipY = false) const;
 ...
 private:
  ...
  LaserRangeFinder(const Name& rName) : Sensor(rName), m_NumberOfRangeReadings(0) {
    ...
    m_pAngularResolution =
        new Parameter<kt_double>("AngularResolution", math::DegreesToRadians(1), GetParameterManager());
...
class CoordinateConverter {
 ...
 public:
   ...
   * @return scaled value
   */
  inline kt_double Transform(kt_double value) { return value * m_Scale; }
   ...
   * @return scale
   */
  inline kt_double GetScale() const { return m_Scale; }

  /**
   * Sets the scale
   * @param scale
   */
  inline void SetScale(kt_double scale) { m_Scale = scale; }

  /**
   * Gets the offset
   * @return offset
   */
  inline const Vector2<kt_double>& GetOffset() const { return m_Offset; }

  /**
   * Sets the offset
   * @param rOffset
   */
  inline void SetOffset(const Vector2<kt_double>& rOffset) { m_Offset = rOffset; }

  /**
   * Sets the size
   * @param rSize
   */
  inline void SetSize(const Size2<kt_int32s>& rSize) { m_Size = rSize; }

  /**
   * Gets the size
   * @return size
   */
  inline const Size2<kt_int32s>& GetSize() const { return m_Size; }

  /**
   * Gets the resolution
   * @return resolution
   */
  inline kt_double GetResolution() const { return 1.0 / m_Scale; }

  /**
   * Sets the resolution
   * @param resolution
   */
  inline void SetResolution(kt_double resolution) { m_Scale = 1.0 / resolution; }
...
class Grid {
 ...
 public:
  ...
  virtual kt_int32s GridIndex(const Vector2<kt_int32s>& rGrid, kt_bool boundaryCheck = true) const {
    if (boundaryCheck == true) {
      if (IsValidGridIndex(rGrid) == false) {
        ...
        error << "Index " << rGrid << " out of range.  Index must be between [0; " << m_Width << ") and [0; "
              << m_Height << ")";
   ...
   */
  inline kt_int32s GetWidth() const { return m_Width; };

  /**
   * Gets the height of the grid
   * @return height of the grid
   */
  inline kt_int32s GetHeight() const { return m_Height; };

  /**
   * Get the size as a Size2<kt_int32s>
   * @return size of the grid
   */
  inline const Size2<kt_int32s> GetSize() const { return Size2<kt_int32s>(m_Width, m_Height); }

  /**
   * Gets the width step in bytes
   * @return width step
   */
  inline kt_int32s GetWidthStep() const { return m_WidthStep; }
   ...
   * @return data size
   */
  inline kt_int32s GetDataSize() const { return m_WidthStep * m_Height; }
   ...
   */
  inline CoordinateConverter* GetCoordinateConverter() const { return m_pCoordinateConverter; }

  /**
   * Gets the resolution
   * @return resolution
   */
  inline kt_double GetResolution() const { return GetCoordinateConverter()->GetResolution(); }

  /**
   * Gets the grids bounding box
   * @return bounding box
   */
  inline BoundingBox2 GetBoundingBox() const { return GetCoordinateConverter()->GetBoundingBox(); }
 ...
 protected:
   ...
   * @param height
   */
  Grid(kt_int32s width, kt_int32s height) : m_pData(NULL), m_pCoordinateConverter(NULL) { Resize(width, height); }
...
class KARTO_EXPORT SensorData : public Object {
 ...
 public:
   ...
   * @return sensor id
   */
  inline kt_int32s GetStateId() const { return m_StateId; }

  /**
   * Sets sensor data id
   * @param stateId id
   */
  inline void SetStateId(kt_int32s stateId) { m_StateId = stateId; }

  /**
   * Gets sensor unique id
   * @return unique id
   */
  inline kt_int32s GetUniqueId() const { return m_UniqueId; }

  /**
   * Sets sensor unique id
   * @param uniqueId
   */
  inline void SetUniqueId(kt_int32u uniqueId) { m_UniqueId = uniqueId; }

  /**
   * Gets sensor data time
   * @return time
   */
  inline kt_double GetTime() const { return m_Time; }

  /**
   * Sets sensor data time
   * @param time
   */
  inline void SetTime(kt_double time) { m_Time = time; }
   ...
   * @param pCustomData
   */
  inline void AddCustomData(CustomData* pCustomData) { m_CustomData.push_back(pCustomData); }
...
class LaserRangeScan : public SensorData {
 ...
 public:
   ...
   */
  inline kt_double* GetRangeReadings() const { return m_pRangeReadings; }
  ...
  inline void SetRangeReadings(const RangeReadingsVector& rRangeReadings) {
    ...
    if (!rRangeReadings.empty()) {
      ...
      // copy readings
      kt_int32u index = 0;
      const_forEach(RangeReadingsVector, &rRangeReadings) { m_pRangeReadings[index++] = *iter; }
    } else {
      delete[] m_pRangeReadings;
...
class DrivePose : public SensorData {
 ...
 public:
   ...
   */
  inline const Pose3& GetOdometricPose() const { return m_OdometricPose; }

  /**
   * Sets the odometric pose of this scan
   * @param rPose
   */
  inline void SetOdometricPose(const Pose3& rPose) { m_OdometricPose = rPose; }
    ...
    if (pLaserRangeFinder != NULL) {
      ...
      for (kt_int32u i = 0; i < pLaserRangeFinder->GetNumberOfRangeReadings(); i++, beamNum++) {
        ...
        if (!math::InRange(rangeReading, pLaserRangeFinder->GetMinimumRange(), rangeThreshold)) {
          ...
          point.SetX(scanPose.GetX() + (1.5 * cos(angle)));
          point.SetY(scanPose.GetY() + (1.5 * sin(angle)));
      ...
      forEach(PointVectorDouble, &m_PointReadings) { m_BoundingBox.Add(*iter); }
    }
...
class OccupancyGrid : public Grid<kt_int8u> {
 ...
 public:
   ...
   */
  void SetMinPassThrough(kt_int32u count) { m_pMinPassThrough->SetValue(count); }

  /**
   * Sets the minimum ratio of beams hitting cell to beams passing through
   * cell for cell to be marked as occupied.
   */
  void SetOccupancyThreshold(kt_double thresh) { m_pOccupancyThreshold->SetValue(thresh); }
 ...
 protected:
   ...
   */
  virtual Grid<kt_int32u>* GetCellHitsCounts() { return m_pCellHitsCnt; }

  /**
   * Get cell pass grid
   * @return Grid<kt_int32u>*
   */
  virtual Grid<kt_int32u>* GetCellPassCounts() { return m_pCellPassCnt; }
 ...
 protected:
  ...
  static void ComputeDimensions(const LocalizedRangeScanVector& rScans, kt_double resolution, kt_int32s& rWidth,
    ...
    const_forEach(LocalizedRangeScanVector, &rScans) { boundingBox.Add((*iter)->GetBoundingBox()); }
  ...
  virtual kt_bool AddScan(LocalizedRangeScan* pScan, kt_bool doUpdate = false) {
    ...
    kt_double maxRange = pScan->GetLaserRangeFinder()->GetMaximumRange() - 0.1;
...
class DatasetInfo : public Object {
 ...
 public:
   ...
   * Dataset title
   */
  const std::string& GetTitle() const { return m_pTitle->GetValue(); }

  /**
   * Dataset author(s)
   */
  const std::string& GetAuthor() const { return m_pAuthor->GetValue(); }

  /**
   * Dataset description
   */
  const std::string& GetDescription() const { return m_pDescription->GetValue(); }

  /**
   * Dataset copyrights
   */
  const std::string& GetCopyright() const { return m_pCopyright->GetValue(); }
...
class Dataset {
 public:
   ...
   * Default constructor
   */
  Dataset() : m_pDatasetInfo(NULL) {}

  /**
   * Destructor
   */
  virtual ~Dataset() { Clear(); }
 ...
 public:
   ...
   * @return sensor state
   */
  inline const ObjectVector& GetObjects() const { return m_Objects; }

  /**
   * Get dataset info
   * @return dataset info
   */
  inline DatasetInfo* GetDatasetInfo() { return m_pDatasetInfo; }

  /**
   * Delete all stored data
   */
  virtual void Clear() {
    for (std::map<Name, Sensor*>::iterator iter = m_SensorNameLookup.begin(); iter != m_SensorNameLookup.end();
         ++iter) {
      karto::SensorManager::GetInstance()->UnregisterSensor(iter->second);
    }

    forEach(ObjectVector, &m_Objects) { delete *iter; }
...
class LookupArray {
 ...
 public:
   ...
   * Clear array
   */
  void Clear() { memset(m_pArray, 0, sizeof(kt_int32s) * m_Capacity); }

  /**
   * Gets size of array
   * @return array size
   */
  kt_int32u GetSize() const { return m_Size; }
   ...
   */
  inline kt_int32s* GetArrayPointer() { return m_pArray; }

  /**
   * Gets array pointer
   * @return array pointer
   */
  inline kt_int32s* GetArrayPointer() const { return m_pArray; }
...
class GridIndexLookup {
 ...
 public:
   ...
   */
  const std::vector<kt_double>& GetAngles() const { return m_Angles; }
  ...
  void ComputeOffsets(LocalizedRangeScan* pScan, kt_double angleCenter, kt_double angleOffset,
    ...
    // 这里改为获取过滤后的数据
    const PointVectorDouble& rPointReadings = pScan->GetPointReadings(false);
    // LOG(INFO) << "filtered points size:" << rPointReadings.size() ;
  ...
  void ComputeOffsets(kt_int32u angleIndex, kt_double angle, const Pose2Vector& rLocalPoints,
    ...
    const_forEach(Pose2Vector, &rLocalPoints) {
      ...
      if (std::isnan(pScan->GetRangeReadings()[readingIndex]) || std::isinf(pScan->GetRangeReadings()[readingIndex]) ||
          pScan->GetRangeReadings()[readingIndex] > maxRange || pScan->GetRangeReadings()[readingIndex] < minRange) {
...
inline Pose2::Pose2(const Pose3& rPose) : m_Position(rPose.GetPosition().GetX(), rPose.GetPosition().GetY()) {
  kt_double t1, t2;
