 ...
 */
inline kt_double DegreesToRadians(kt_double degrees) { return degrees * KT_PI_180; }
 ...
 */
inline kt_double RadiansToDegrees(kt_double radians) { return radians * KT_180_PI; }
 ...
 */
inline kt_double Round(kt_double value) { return value >= 0.0 ? floor(value + 0.5) : ceil(value - 0.5); }
