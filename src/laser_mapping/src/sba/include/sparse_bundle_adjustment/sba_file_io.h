...
int ParseGraphFile(
    ...
    std::vector<std::vector<Eigen::Vector11d, Eigen::aligned_allocator<Eigen::Vector11d> > >
        &ptts  // point tracks - each vector is <camera_index u v>
);
